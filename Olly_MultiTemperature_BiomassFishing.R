...
plot(pred_bio_output_matrix[1, ]~fishing_mortality_rate, type = "l", lwd = 1, las = 1, pch = 0, lty = 3, xlab = x.expression, ylab = "Total Predator Biomass", cex.lab = 1.3, cex.axis = 1, xaxs = "i", yaxs = "i", xlim = c(0, 1.05), ylim = c(0,40), col = "black")
...
legend(x="topright", legend = c("Predator growth conversion efficiency = 0.30", "Predator growth conversion efficiency = 0.25", "Predator growth conversion efficiency = 0.20", "Predator growth conversion efficiency = 0.15", "Predator growth conversion efficiency = 0.10", "Predator growth conversion efficiency = 0.05", "Predator growth conversion efficiency = 0.00"), col = c("red", "black", "black", "black", "black", "black", "black"), lty = c(7, 5, 4, 1, 2, 3, 6))
